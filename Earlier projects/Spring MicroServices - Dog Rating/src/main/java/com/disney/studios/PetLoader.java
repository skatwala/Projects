...
public class PetLoader implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
    	breedService.createBreed("L", "Labrador");
        loadBreed("Labrador", labradors);
        breedService.createBreed("P", "Pugs");
        loadBreed("Pugs", pugs);
        breedService.createBreed("R", "Retriever");
        loadBreed("Retriever", retrievers);
        breedService.createBreed("Y", "Yorkie");
    ...
    private void loadBreed(String breed, Resource source) throws IOException {
        try ( BufferedReader br = new BufferedReader(new InputStreamReader(source.getInputStream()))) {
            ...
            while ((line = br.readLine()) != null) {
                 ...
                 *       the datasource.
                 */
                dogService.createDog("BestDog", breed, line);
            }
        }
    }
}
