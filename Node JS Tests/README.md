This show the options available to test NodeJS MicroServices.  A MicroService for Restaurant reservation that uses SQL Lite and JOI (for schema validation) is tested
